...
GENERATED_DIR = "ds_result"
PARTS_NUMBER = sys.argv[2]
...
f_profile = open(GENERATED_DIR+"gs_profile.txt", "w")
f_name = open(GENERATED_DIR+"gs_name.txt", "w")
f_year = open(GENERATED_DIR+"gs_earliest_year.txt", "w")
f_google_id = open(GENERATED_DIR+"gs_google_id.txt", "w")


f_h_age = open(GENERATED_DIR+"gs_h_age.txt", "w") # h-index vs experience
f_g_age = open(GENERATED_DIR+"gs_g_age.txt", "w") # g-index vs experience
f_t_age = open(GENERATED_DIR+"gs_t_age.txt", "w") # total vs experience



f_title = open(GENERATED_DIR+"gs_title.txt", "w") # academic title
f_h_idx = open(GENERATED_DIR+"gs_h_idx.txt", "w")
f_g_idx = open(GENERATED_DIR+"gs_g_idx.txt", "w")
f_t_idx = open(GENERATED_DIR+"gs_t_idx.txt", "w")
...
if (compute_collaboration_graph == 1):
    print datetime.now()
    f_node_list = open(GENERATED_DIR+"gs_graph_nodes.txt", "w")
    f_country_node_list = open(GENERATED_DIR+"gs_country_graph_nodes.txt", "w")
 ...
 #   f_yr_graph = open("gs_collaboration_yearly_graph.txt", "w")
    ...
    if (len(sys.argv) == 2):
        number = sys.argv[1]
        f_graph = open(GENERATED_DIR + "gs_collaboration_graph"+number+".txt", "w")
        f_yr_graph = open(GENERATED_DIR + "gs_collaboration_yearly_graph"+number+".txt", "w")

        # if (sys.argv[1] == '1'):
        #     f_graph = open(GENERATED_DIR+"gs_collaboration_graph1.txt", "w")
        #     f_yr_graph = open(GENERATED_DIR+"gs_collaboration_yearly_graph1.txt", "w")
        # elif (sys.argv[1] == '2'):
        ...
        f_yr_graph = open(GENERATED_DIR+"gs_collaboration_yearly_graph.txt", "w")
        f_graph = open(GENERATED_DIR+"gs_collaboration_graph.txt", "w")
    ...
    for i in range(0, total):
        ...
        if (len(sys.argv) == 2):
            if (i % PARTS_NUMBER != int(sys.argv[1])):
                continue

            f_graph = open("gs_collaboration_graph"+sys.argv[1]+".txt", "a")
            f_yr_graph = open("gs_collaboration_yearly_graph"+sys.argv[1]+".txt", "a")
            # if (sys.argv[1] == '1'):
            ...
            f_yr_graph = open(GENERATED_DIR+"gs_collaboration_yearly_graph.txt", "a")
            f_graph = open(GENERATED_DIR+"gs_collaboration_graph.txt", "a")
